    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <a href="{{ route('login') }}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900">
                        {{ __('Log in') }}
                    </a>
                @endauth
            </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @else
                <div class="px-4 py-3 space-y-2">
                    <a href="{{ route('login') }}" class="block text-sm font-medium text-gray-700">{{ __('Log in') }}</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="block text-sm font-medium text-gray-700">{{ __('Register') }}</a>
                    @endif
                </div>
            @endauth
        </div>
