        ...
        <form action="{{ route('products.store') }}" method="POST" class="space-y-4 rounded-lg bg-white p-6 shadow-sm">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="number" name="safety_stock" value="{{ old('safety_stock', 10) }}" class="w-full rounded border-gray-300" required>
                ...
                <div>
                    ...
                    <input type="number" name="reorder_level" value="{{ old('reorder_level', 40) }}" class="w-full rounded border-gray-300" required>
