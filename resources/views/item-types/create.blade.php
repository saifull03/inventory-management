<x-app-layout>
    ...
    <div class="p-6">
        ...
        <form action="{{ route('item-types.store') }}" method="POST" class="space-y-4 rounded-lg bg-white p-6 shadow-sm">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="prefix" value="{{ old('prefix') }}" class="w-full rounded border-gray-300" required>
            </div>
            ...
            <div class="flex gap-3">
                <button type="submit" class="rounded bg-blue-600 px-4 py-2 text-white">Save Item Type</button>
